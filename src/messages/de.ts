...
const de: Messages = {
  ...
  hero: {
    ...
    metrics: [
      { target: 99.8, decimals: 1, prefix: "", suffix: "%", label: "Pünktlichkeit" },
      { target: 24, decimals: 0, prefix: "", suffix: "/7", label: "VIP-Disposition" },
      { target: 0, decimals: 0, prefix: "€", suffix: "", label: "Verspätungszuschlag" },
    ],
  },
  booking: {
