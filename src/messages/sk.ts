...
const sk: Messages = {
  ...
  hero: {
    ...
    metrics: [
      { target: 99.8, decimals: 1, prefix: "", suffix: "%", label: "Presnosť príchodu" },
      { target: 24, decimals: 0, prefix: "", suffix: "/7", label: "VIP dispečing" },
      { target: 0, decimals: 0, prefix: "€", suffix: "", label: "Príplatok za meškanie letu" },
    ],
  },
  booking: {
