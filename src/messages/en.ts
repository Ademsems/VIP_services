...
const en: Messages = {
  ...
  hero: {
    ...
    metrics: [
      { target: 99.8, decimals: 1, prefix: "", suffix: "%", label: "On-Time Punctuality" },
      { target: 24, decimals: 0, prefix: "", suffix: "/7", label: "VIP Dispatch" },
      { target: 0, decimals: 0, prefix: "€", suffix: "", label: "Flight Delay Surcharge" },
    ],
  },
  booking: {
